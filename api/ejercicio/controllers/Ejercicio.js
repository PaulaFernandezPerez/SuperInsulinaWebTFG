...
/**
 * A set of functions called "actions" for `Ejercicio`
 */

module.exports = {

  /**
   * Get Ejercicio entries.
   *
   * @return {Object|Array}
   */
  ...
  /**
   * Add an entry to a specific Ejercicio.
   *
   * @return {Object}
   */
  ...
  /**
   * Remove a specific entry from a specific Ejercicio.
   *
   * @return {Object}
   */
